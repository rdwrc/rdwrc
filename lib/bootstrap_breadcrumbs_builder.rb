...
#
# SEE https://gist.github.com/riyad/1933884
#   only change to this code was to remove the separator since Twitter Bootstrap does that automatically
...
# SEE https://gist.github.com/riyad/1933884#comment-865847
#   only change to this code was to remove the separator since Twitter Bootstrap does that automatically
class BootstrapBreadcrumbsBuilder < BreadcrumbsOnRails::Breadcrumbs::Builder
  def render
    @context.content_tag(:ul, :class => 'breadcrumb') do
